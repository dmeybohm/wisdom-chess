...
TEST_CASE("Castling state is modified and restored for rooks", "[castling]")
{
    ...
    do_move(board, COLOR_BLACK, &mv, NO_MOVE_OPTIONS);
    ...
    undo_move(board, COLOR_BLACK, &mv, NO_MOVE_OPTIONS);
...
TEST_CASE("Castling state is modified and restored for castling kingside", "[castling]")
{
    ...
    do_move (board, COLOR_WHITE, &mv,  NO_MOVE_OPTIONS);
    ...
    undo_move (board, COLOR_WHITE, &mv,  NO_MOVE_OPTIONS);
