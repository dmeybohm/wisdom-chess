...
namespace wisdom
{
    ...
    void MoveGeneration::king ()
    {
        ...
        if (board.able_to_castle (who, CastlingIneligible::Queenside) && piece_col == King_Column)
        {
        ...
        if (board.able_to_castle (who, CastlingIneligible::Kingside) && piece_col == King_Column)
        {
