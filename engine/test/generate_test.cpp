...
TEST_CASE("generate default moves")
{
    ...
    auto move_list = MoveGenerator::generateAllPotentialMoves (board, Color::White);
...
TEST_CASE("generate en passant moves")
{
    ...
    auto move_list = MoveGenerator::generateAllPotentialMoves (board, Color::White).asString();
...
TEST_CASE( "Generated moves are sorted by capturing difference of pieces" )
{
    ...
    auto move_list = MoveGenerator::generateAllPotentialMoves (board, Color::Black);
