...
int is_king_threatened_column (struct board *board, color_t who,
                        unsigned char king_row, unsigned char king_col)
{
  int           row, col;
  piece_t       what;
...
int is_king_threatened_row (struct board *board, color_t who,
                        unsigned char king_row, unsigned char king_col)
{
  int           row, col;
  piece_t       what;
...
int is_king_threatened_diagonal (struct board *board, color_t who,
                        unsigned char king_row, unsigned char king_col)
{
...
int is_king_threatened_knight (struct board *board, color_t who,
                        unsigned char king_row, unsigned char king_col)
{
  int           row, col;
  piece_t       what;
...
int is_king_threatened_pawn (struct board *board, color_t who,
                        unsigned char king_row, unsigned char king_col)
{
  int           row, col;
  piece_t       what;
...
int is_king_threatened_king (struct board *board, color_t who,
                        unsigned char king_row, unsigned char king_col)
{
  int           row, col;
  piece_t       what;
